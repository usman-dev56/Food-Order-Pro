...
<nav class="navbar">
    ...
    <div id="inner-header">
        <div class="hero-text">
            <h1>Welcome to FoodOrderPro!</h1>
            <p id="para">Hungry? we've got you covered! At FoodOrderPro, we make it easy to get your favorite food delivered fast.
                From desi meals to fast food and healthy choices, we have somethings for everyone.</p>
    ...
    <div class="categories-container">
        <h2 class="text-center">Our Top Categories </h2>

        <div class="category-container">
            <!-- Fetch dynamic data from the database -->
            <?php 
                $sql = 'SELECT * FROM tbl_category WHERE available="Yes" AND highlighted="Yes" LIMIT 6';
...
<section class="food-menu">
    <div class="container">
        <h2  id="food-menu-txt">Our Top Foods </h2>

        <div class="food-menu-container">
              
            <?php 
            $sql2 = 'SELECT * FROM tbl_food  WHERE available="Yes" AND highlighted="Yes" LIMIT 6';
