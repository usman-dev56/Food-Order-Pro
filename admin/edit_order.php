...
<div class="main-content">
    ...
    <form action="" method="post" enctype="multipart/form-data" class="form-container horizontal-form">
        <div class="form-group">
            ...
            <input type="text" name="title" id="title" value="<?php echo $food; ?>" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" name="qty" id="qty" value="<?php echo $qty; ?>" required>
        </div>
...
<?php 
            ...
            if(isset($_POST['submit']))
            {
               ...
               // Escape special characters in the inputs to avoid SQL injection
        ...
        $customer_address = mysqli_real_escape_string($conn, $_POST['customer_address']);
                ...
                {
                    //Failed to Update
                    $_SESSION['fail_to_update'] = "<div class='error'>Failed to Update Order.</div>";
                    header('location:'.SITEURL.'admin/orders.php');
                }
            }
        ?>
